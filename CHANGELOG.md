...
### Added
- **Pause-work example** - Adds a copy-pastable `$gsd-pause-work` playbook for recording handoff state before context resets, machine switches, or maintainer handoffs.
