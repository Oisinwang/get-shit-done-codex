...
**Researcher (rounds 1�?):** Ground the discussion in current reality.
...
**Seed Closer (rounds 5�?):** Lock remaining undecided territory.
...
```
Goal Clarity:       [score 0.0�?.0]
Boundary Clarity:   [score 0.0�?.0]
Constraint Clarity: [score 0.0�?.0]
Acceptance Criteria:[score 0.0�?.0]
...
**Max 6 rounds.** Each round: 2�? questions max. End round after user responds.
...
- Rounds 5�?: Seed Closer (focus on lowest-scoring dimensions)
...
Use the SPEC.md template from @~/.codex/get-shit-done/templates/spec.md.
...
- Max 2�? questions per round �?do not frontload all questions at once
</critical_rules>
