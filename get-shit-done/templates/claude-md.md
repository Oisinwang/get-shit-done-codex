...
The `generate-agents-md` subcommand manages 6 sections (project, stack, conventions, architecture, skills, workflow enforcement).
The profile section is managed exclusively by `generate-agents-profile`.
...
**Note:** This section is NOT managed by `generate-agents-md`. It is managed exclusively
by `generate-agents-profile`. The placeholder above is only used when creating a new
