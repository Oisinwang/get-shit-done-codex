...
|------|-----------|---------------|---------|--------|---------|
| **Patch** | Bug fixes only | `1.27.1` | `latest` | `hotfix/1.27.1` | `npx @oisinwang/get-shit-done-codex@latest` |
| **Minor** | Fixes + enhancements | `1.28.0` | `latest` (after RC) | `release/1.28.0` | `npx @oisinwang/get-shit-done-codex@next` (RC) |
| **Major** | Fixes + enhancements + features | `2.0.0` | `latest` (after beta) | `release/2.0.0` | `npx @oisinwang/get-shit-done-codex@next` (beta) |
...
|-----|---------|-------------|
| `latest` | Stable production release | `npm install @oisinwang/get-shit-done-codex` (default) |
| `next` | Pre-release (RC or beta) | `npm install @oisinwang/get-shit-done-codex@next` (opt-in) |
...
4. Test the RC: `npx @oisinwang/get-shit-done-codex@next`
...
npm dist-tag ls @oisinwang/get-shit-done-codex
```
