...
describe('public release metadata', () => {
  ...
  test('public examples help first-time users choose a workflow', () => {
    ...
    assert.match(readme, /real-world scenarios/);
    assert.match(docsReadme, /\[Examples\]\(EXAMPLES\.md\)/);
    assert.match(examples, /# Examples/);
    assert.match(examples, /## Real-World Scenarios/);
    assert.match(examples, /### Ship A Small Bugfix Without Losing Review Evidence/);
    assert.match(examples, /### Evaluate GSD On An Existing Repository/);
    assert.match(examples, /### Recover A Long-Running Session After Context Reset/);
    assert.match(examples, /\*\*Starting problem:\*\*/);
    assert.match(examples, /\*\*GSD flow:\*\*/);
    assert.match(examples, /\*\*Artifact or verification:\*\*/);
    assert.match(examples, /regression test, focused verification command, and commit-sized review trail/);
    assert.match(examples, /codebase map, project state, and a first phase discussion/);
    assert.match(examples, /handoff file, progress audit, and resumed next action/);
  ...
  test('public roadmap shows active direction and contributor-sized work', () => {
    ...
    assert.doesNotMatch(roadmap, /Expand public examples with real-world scenarios/);
    ...
    assert.doesNotMatch(roadmap, /localized docs index release checklist table links/);
  ...
  test('CHANGELOG current compare link points at the public Codex fork', () => {
    ...
    assert.match(unreleasedSection, /Localized docs index comparison links/);
    ...
    assert.match(unreleasedSection, /Localized docs index release checklist table links/);
    assert.match(unreleasedSection, /docs\/RELEASE\.md/);
    assert.match(unreleasedSection, /Localized docs index maintainer checklist table links/);
