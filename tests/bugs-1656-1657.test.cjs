...
// flow that shipped when `@oisinwang/get-shit-done-codex-sdk` did not yet exist on npm. The
...
describe('#1657 / #2385: SDK install must be wired into installer source', () => {
  ...
  test('install.js builds gsd-sdk from in-repo sdk/ source (#2385)', () => {
    ...
    // @oisinwang/get-shit-done-codex-sdk from npm because that published version lags the source
