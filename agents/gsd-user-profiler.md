...
<reference>
@~/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `~/.codex/get-shit-done/references/user-profiling.md` to load:
